...
Begin VB.Form Form2 
   ...
   Begin VB.CheckBox opts 
      Caption         =   "Crackear Office 2000"
      Height          =   465
      Left            =   3075
      Style           =   1  'Graphical
      TabIndex        =   12
   ...
   Begin VB.Image Image2 
      Height          =   480
      Left            =   7530
      MouseIcon       =   "Form2.frx":C6C0C
      Picture         =   "Form2.frx":C74D6
      Top             =   3000
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image Image1 
      Height          =   480
      Left            =   7530
      MouseIcon       =   "Form2.frx":C7DA0
      Picture         =   "Form2.frx":C866A
      Top             =   3015
      Width           =   480
   End
...
Private Sub Command1_Click()
    If opts.Value = 0 Then
SetStringValue "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{00000416-78E1-11D2-B60F-006097C998E7", "RegOwner", (Text1.Text)
SetStringValue "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{00000416-78E1-11D2-B60F-006097C998E7", "RegCompany", (Text2.Text)
Text4.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{00000416-78E1-11D2-B60F-006097C998E7", "RegOwner")
Text3.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{00000416-78E1-11D2-B60F-006097C998E7", "RegCompany")

End If
    If opts.Value = 1 Then
SetStringValue "HKEY_LOCAL_MACHINE\SOFTWARE\COREL", "UserName", (Text1.Text)
SetStringValue "HKEY_LOCAL_MACHINE\SOFTWARE\COREL", "Organization", (Text2.Text)
Text4.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\COREL", "UserName")
Text3.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\COREL", "Organization")
...
SetStringValue "HKEY_LOCAL_MACHINE\Software\KeyDefine", "Windows Status", ("Cracked by D@v!ncY")
...
If opts.Value = 0 Then
opts.Caption = "Crackear Office 2000"
Text4.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{00000416-78E1-11D2-B60F-006097C998E7\}", "RegOwner")
Text3.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{00000416-78E1-11D2-B60F-006097C998E7\}", "RegCompany")
End If
If opts.Value = 1 Then
Text4.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\COREL\)", "UserName")
Text3.Text = GetStringValue("HKEY_LOCAL_MACHINE\SOFTWARE\COREL\}", "Organization")
opts.Caption = "Crackear Corel Draw 9 ou 10"
End If
End Sub
